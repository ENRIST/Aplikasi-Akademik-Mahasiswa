...
class _MainPageState extends State<MainPage> {
  ...
  final List<Widget> _pages = [
    ...
    StatusMahasiswaPage(),                                  
    const Center(child: Text('Halaman Kalender (Belum Ada)')), 
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            ...
            _buildNavItem(icon: Icons.home_outlined, activeIcon: Icons.home, index: 1),
  ...
  Widget _buildNavItem({required IconData icon, IconData? activeIcon, required int index}) {
    ...
    return GestureDetector(
      ...
      child: isActive
          ? Container(
              ...
              child: Icon(activeIcon ?? icon, color: const Color(0xFF2196F3), size: 22),
            )
